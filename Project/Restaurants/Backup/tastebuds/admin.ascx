<%@ Control Language="c#" Inherits="OnlineFastFood.admin" CodeFile="admin.ascx.cs" %>
<LINK href="imenus0.css" type="text/css" rel="stylesheet">
<div></div>
<DIV>
	<div style="DISPLAY: none; WIDTH: 90px">
		<ul id="imenus0">
			<li style="WIDTH: 100px">
				<A href="adminhomepage.aspx">Home</A>
			</li>
			<li style="WIDTH: 100px">
				<A href="ManageItems.aspx">ItemDetails</A>
			</li>
			<li style="WIDTH: 120px; HEIGHT: 31px">
				<A href="userinformation.aspx">User Information</A>
			</li>
			<li style="WIDTH: 130px">
				<A href="vieworders.aspx">View Details</A>
			</li>
			<li style="WIDTH: 100px">
				<A href="adminfeedback.aspx">Survey Report</A>
			</li>
			<li style="WIDTH: 100px">
