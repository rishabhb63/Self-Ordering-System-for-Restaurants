<%@ Control Language="c#" Inherits="OnlineFastFood.sidemenu2" CodeFile="sidemenu2.ascx.cs" %>
<LINK href="imenus0.css" type="text/css" rel="stylesheet">
<div></div>
<DIV>
	<div style="DISPLAY: none; WIDTH: 328px; HEIGHT: 256px">
		<ul id="imenus0">
			<li style="WIDTH: 100px">
				<A href="Recipesdetails.aspx">Home</A>
			</li>
			<li style="WIDTH: 100px">
