...
<HTML>
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<asp:panel id="Panel1" style="Z-INDEX: 101; LEFT: 10%;  TOP: 0%" runat="server"
				 Height="607px" Width="101%" BorderWidth="1" BorderColor="Black">
				<TABLE id="Table1" height="530" cellSpacing="0" cellPadding="1" width="100%" border="0">
					...
					<TR>
						<TD style="HEIGHT: 31px" vAlign="middle" align="right" width="100%" 
                        colSpan="2" height="31" bgcolor="#CCFFFF">
					...
					<TR>
						<TD vAlign="top"  width="100%" height="170">
							
								<TABLE id="Table2" >
									<tr><td valign="top" colspan="2" class="style7" bgcolor="#CCFFFF">
                                        <asp:ImageButton ID="ImageButton1" runat="server" Height="305px" 
                                            ImageUrl="~/Images/fast-food-restaurant.jpg" Width="395px" />
                                        </td>
									
										<TD vAlign="middle" align="right" width="300" class="style6" rowspan="2" 
                                            bgcolor="#CCFFFF">
